(function (global) {
  ...
  const agreement = "Сублицензионный договор (Предоплата 100%) от 15.12.2025";
  ...
  global.LkpDemoData = {
    schemaVersion: 5,
    nextIds: { organization: 103, contact: 203, cart: 653, order: 1001, activation: 125, reference: 1000, invoicePg: 100, invoiceRr: 100 },
    ...
    products: [
      ...
      { code: "RR-01F", name: "ККТ РР-01Ф", groupName: "ККТ", vendor: "РР-Электро", rrpCents: 2700000, partnerPriceCents: 2350000, priceCents: 2180000, availableOrganizationIds: ["101", "102"], isActive: true },
    ...
    orders: [
      {
        number: "12540", cartNumber: "", organizationId: "101", vendor: "Пэй Киоск", type: "Активация лицензий", activationNumber: "123",
        status: "Отгружен", paymentStatus: "Оплачено", invoiceNumber: "ПГ-362", deliveryTerms: "Предоплата 100%",
        agreement, contactName: "Колесников В. В.", contactPhone: "+7 987 654 32 10", contactEmail: "example@mail.ru",
        comment: "Активация № 123", createdAt: "2026-08-06T00:00:00.000Z", totalCents: 400000,
        items: [
      ...
      {
        number: "12480", cartNumber: "", organizationId: "101", vendor: "Пи Джи Групп", type: "Авансовый платеж",
        status: "Отгружен", paymentStatus: "Оплачено", invoiceNumber: "ПГ-098", deliveryTerms: "Предоплата 100%",
        agreement, contactName: "Петров Петр", contactPhone: "+7 987 654 32 10", contactEmail: "example@mail.ru",
        comment: "", createdAt: "2026-07-30T00:00:00.000Z", totalCents: 1000000,
        items: [{ code: "ADVANCE", name: "Авансовый платеж", vendor: "Пи Джи Групп", quantity: 1, unitPriceCents: 1000000, lineTotalCents: 1000000 }],
        history: [{ fromStatus: null, toStatus: "Отгружен", changedAt: "2026-07-30T00:00:00.000Z", changedBy: "Демо" }]
      }
    ],
    licenses: [
    ...
    activations: [
      {
        id: "123", number: "123", orderNumber: "12540", organizationId: "101", status: "Выполнена", vendor: "Пэй Киоск",
      ...
      {
        id: "124", number: "124", orderNumber: "", organizationId: "101", status: "В работе", vendor: "Пи Джи Групп",
        totalCents: 2490000, paymentStatus: "Оплачено", orderedAt: "2026-08-01T00:00:00.000Z", comment: "", simulator: "ФР-Крипто",
        items: [
    ...
    contracts: [
      reference("contracts", "main", "Основной договор"),
      reference("contracts", "other-active", "Другой активный договор")
    ],
    references: {
      partners: [reference("partners", "partner", "ООО «Партнер»", "Постоянный партнер")],
      "price-types": [
        reference("price-types", "rrp", "РРЦ (Розница)"),
        reference("price-types", "partner", "Партнер"),
        reference("price-types", "permanent-partner", "Постоянный партнер")
      ],
      "partner-statuses": [reference("partner-statuses", "permanent", "Постоянный партнер")],
      vendors: [
        reference("vendors", "pg-group", "Пи Джи Групп"),
        reference("vendors", "rr-electro", "РР-Электро"),
        reference("vendors", "pay-kiosk", "Пэй Киоск")
      ],
      "delivery-terms": [
        reference("delivery-terms", "prepayment-100", "Предоплата 100%"),
        reference("delivery-terms", "deferment-5", "Отсрочка 5 дней")
      ],
      "contract-types": [reference("contract-types", "sublicense", "Сублицензионный договор")],
      categories: [reference("categories", "cash-equipment", "Кассовое оборудование")],
      "product-groups": [
        reference("product-groups", "pak", "ПАК"),
        reference("product-groups", "accessories", "Аксессуары"),
        reference("product-groups", "kkt", "ККТ")
      ],
      "order-statuses": [
        reference("order-statuses", "status-1", "Принят"),
        reference("order-statuses", "status-2", "Ожидает сборки"),
        reference("order-statuses", "status-3", "Готов к отгрузке"),
        reference("order-statuses", "status-4", "Отгружен")
      ],
      models: [
        reference("models", "aqsi-5f", "aQsi 5Ф"),
        reference("models", "aqsi-6f", "aQsi 6Ф"),
        reference("models", "aqsi-13", "aQsi 13"),
        reference("models", "rr-01f", "РР-01Ф"),
        reference("models", "rr-04f", "РР-04Ф")
      ]
    },
    balances: { "101": 6000, "102": 0 }
  };
